...
<div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
            <a class="navbar-brand brand-logo mr-5" href="{{ route('home') }}">Feliciano</a>
        </div>
        ...
        <div class="main-panel">
            ...
            <footer class="footer">
                <div class="d-sm-flex justify-content-center justify-content-sm-between">
                    <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © 2021 <a href="https://www.bootstrapdash.com/" target="_blank">Feliciano</a>. All rights reserved.</span>
...
<script src="{{ asset('assets/admin/template.js') }}"></script>
<script src="{{ asset('assets/admin/settings.js') }}"></script>
<script src="{{ asset('assets/admin/todolist.js') }}"></script>
<!-- endinject -->
